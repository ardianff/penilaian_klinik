...
class Model_penilaian_utama extends CI_Model
{
    ...
    {
        $query = $this->db->get_where('tbl_rincian_penilaian_utama', ['delete' => '0'])->result();
        return $query;
    }
    ...
    public function get_question_next()
    {
        ...
        $query = $this->db
            ->join('tbl_group_utama as gu', 'gu.id_group = dpu.id_group', 'inner')
            ->where(['gu.delete' => '0', 'dpu.delete' => '0'])
            ->get('tbl_deskripsi_penilaian_utama as dpu')->result();
        return $query;
    }
    public function cek_no_penilaian($id_klinik)
    {
		...
		k.status_penilaian, k.created_at,k.update_at')
            ...
            ->get_where('tbl_klinik k', ['k.id_klinik' => $id_klinik, 'p.delete' => '0'])
            ->row_array();
        return $query;
    }
    public function cek_hasil_penilaiansatu($id_klinik)
    {
        $query = $this->db->select('pfs.id_penilaian,pr.id_rincian_penilaian, pr.rincian_penilaian, pr.keterangan_penilaian, pfs.no_penilaian, pfs.jawab_hasil, pfs.jawab_hasil_verif, pfs.catatan_hasil_penilaian')
            ...
            ->get_where('tbl_rincian_penilaian_utama pr', ['pfs.id_klinik' => $id_klinik, 'pfs.delete' => '0'])
            ->result();
        return $query;
    }
    ...
    public function get_klinikwithpenilaiansatu($id_klinik)
    {
        ...
        k .status_penilaian, k.created_at,k.update_at,pfs.jawab_hasil, pfs.jawab_hasil_verif, pfs.catatan_hasil_penilaian')
            ...
            ->get_where('tbl_klinik k', ['k.id_klinik' => $id_klinik, 'pfs.delete' => '0'])
            ->row_array();
        return $query;
    }
    ...
    {
        $query = $this->db->select('k.id_klinik,k.nama_klinik,k.nama_anggota1,k.nama_anggota2,k.nama_anggota3,k.nama_anggota4,k.nama_anggota5,k.nama_anggota6,k.kemampuan_pelayanan, k.jenis_pelayanan_klinik, k.alamat_klinik, kec.nama_kecamatan, kel.nama_kelurahan, kel.kode_pos_kelurahan,
    ...
    public function get_data_utama()
    {
        $query = $this->db->select('*')
            ...
            ->get_where('tbl_klinik', ['tbl_klinik.delete' => '0'])->result();
        return $query;
    }
    ...
    public function simpan_penilaian_utama_ketiga($uploadData, $image, $imagettd1, $imagettd2, $imagettd3, $imagettd4, $imagettd5, $imagettd6, $id_klinik, $no_penilaian)
    {
    ...
    public function update_penilaian_utama_ketiga($uploadData, $image, $imagettd1, $imagettd2, $imagettd3, $imagettd4, $imagettd5, $imagettd6, $id_klinik, $no_penilaian)
    {
        $foto_klinik = json_encode($uploadData);
        $result_foto = preg_replace("/[^a-zA-Z0-9-_.,]/", "", $foto_klinik);
        $data = [
    ...
    {
        $query = $this->db->select('pp.id_deskripsi, pp.id_group,pp.kriteria_penilaian_utama,pp.jumlah_minimal_penilaian_utama,pp.satuan_penilaian_utama,gp.group_name, pfk.no_penilaian,pfk.id_klinik,pfk.hasil_penilaian,pfk.jumlah_ketersediaan,pfk.satuan_penilaian,pfk.catatan_penilaian')
