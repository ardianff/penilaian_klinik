               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="#"
                                class="nav-link <?= $this->uri->segment(1) == 'rincian_penilaian_pratama' || $this->uri->segment(1) == 'rincian_penilaian_utama' || $this->uri->segment(1) == '' ? 'active' : '' ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="#"
                                class="nav-link <?= $this->uri->segment(1) == 'rincian_penilaian_pratama_kedua' || $this->uri->segment(1) == 'rincian_penilaian_utama_kedua' || $this->uri->segment(1) == '' ? 'active' : '' ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>
                                    Form 2
                                    <i class="right fas fa-angle-left"></i>
