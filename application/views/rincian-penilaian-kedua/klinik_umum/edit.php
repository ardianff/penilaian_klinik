                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            ...
                            <a href="<?php echo base_url('rincian_penilaian_klinik_umum_kedua/group_name'); ?>"
                                class="btn btn-danger btn-sm">Group Name</a>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <?php echo form_open(
                            'rincian_penilaian_klinik_umum_kedua/update',
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text"
                                        ...
                                        placeholder="Rincian Penilaian"><?= set_value('rincian_penilaian', htmlentities($id_deskripsi->kriteria_penilaian_pratama))  ?></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text"
                                        ...
                                        placeholder="Jumlah"><?= set_value('jumlah_penilaian', htmlentities($id_deskripsi->jumlah_minimal_penilaian_pratama)) ?></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <?php echo form_dropdown(
                                        ...
                                        set_value('satuan_penilaian', $id_deskripsi->satuan_penilaian_pratama),
                        ...
                        <div class="card-footer">
                            ...
                            <?php echo anchor('rincian_penilaian_klinik_umum_kedua', 'Kembali', [
