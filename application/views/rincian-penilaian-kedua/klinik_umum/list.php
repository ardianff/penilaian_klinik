                            ...
                            <table id="example2" class="table table-bordered table-striped" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo $row->jumlah_minimal_penilaian_pratama; ?>
                                        </td>
                                        <td class="text-center"><?php echo $row->satuan_penilaian_pratama; ?></td>
                                        <td class="text-center"><a
                                                onclick="editConfirm('<?php echo site_url('rincian_penilaian_klinik_umum_kedua/edit/' . $row->id_deskripsi) ?>')"
                                                href="#" class="btn btn-warning btn-sm"><i
                                                    class="fas fa-pencil-alt"></i></a></td>
                                        <td class="text-center"><a
                                                onclick="deleteConfirm('<?php echo site_url('rincian_penilaian_klinik_umum_kedua/hapus/' . $row->id_deskripsi) ?>')"
