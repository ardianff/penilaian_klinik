            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-info">
                        ...
                        <!-- form start -->
                        <?php echo form_open(
                            'rincian_penilaian_klinik_gigi_kedua/add',
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" class="form-control <?php if (form_error('rincian_penilaian') == true) : ?>is-invalid <?php endif ?>" name="rincian_penilaian" placeholder="Rincian Penilaian"><?= set_value('rincian_penilaian') ?></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" class="form-control <?php if (form_error('jumlah_penilaian') == true) : ?>is-invalid <?php endif ?>" name="jumlah_penilaian" placeholder="Jumlah"><?= set_value('jumlah_penilaian') ?></textarea>
