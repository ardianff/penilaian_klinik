			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<div class="card card-info">
						...
						<!-- form start -->
						<?php echo form_open(
							'rincian_penilaian_utama_kedua/update_group',
						...
						<div class="card-body">
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="nama_group" placeholder="Nama Group" value="<?php echo $group->group_name; ?>">
						...
						<div class="card-footer">
							...
							<?php echo anchor('rincian_penilaian_utama_kedua/group_name', 'Kembali', [
