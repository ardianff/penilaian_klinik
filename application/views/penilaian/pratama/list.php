                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    <a class="dropdown-item"
                                                        href="<?php echo site_url('penilaian_pratama/print/' . $row->id_klinik); ?>"
                                                        target="_blank">Print</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item"
                                                        href="<?php echo site_url('penilaian_pratama/export_pdf/' . $row->id_klinik); ?>"
                                                        target="_blank">Export PDF</a>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-center"><a
                                                onclick="penilaianConfirm('<?php echo site_url('penilaian_pratama/nilai/' . $row->id_klinik) ?>')"
                                                href="#" title="Penilaian <?php echo $row->nama_klinik ?>"
                                                class="btn btn-primary btn-sm"><i class="fa-solid fa-book"></i></a></td>
                                        <td class="text-center"><a
                                                onclick="editConfirm('<?php echo site_url('penilaian_pratama/edit/' . $row->id_klinik); ?>')"
                                                href="#" class="btn btn-warning btn-sm"
                                                title="Edit Data <?php echo $row->nama_klinik ?>"><i
                                                    class=" fas fa-pencil-alt"></i></a></td>
                                        <td class="text-center"><a
                                                onclick="deleteConfirm('<?php echo site_url('penilaian_pratama/hapus/' . $row->id_klinik) ?>')"
