            ...
            <table border="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td class="text-center"><img src="assets/img/uploads/ttd/<?php echo $klinik['ttd_penilai1'] ?>"
                                width="140px" height="140px"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        <td colspan="5" class="text-center"><img
                                src="assets/img/uploads/ttd/<?php echo $klinik['ttd_penilai3'] ?>" width="140px"
                                height="140px">
                        </td>
                    </tr>
                    <tr>
