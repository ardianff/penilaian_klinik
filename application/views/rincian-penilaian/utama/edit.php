       ...
       ?>
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <textarea type="text" class="form-control" name="rincian_penilaian" placeholder="Rincian Penilaian"><?php echo htmlentities(
               ...
               '</small>'
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <textarea type="text" class="form-control" name="keterangan_penilaian" placeholder="Keterangan"><?php echo htmlentities(
