                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            &nbsp;<?php echo anchor(
                                        'rincian_penilaian_klinik_umum/add',
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a
                                                onclick="editConfirm('<?php echo site_url('rincian_penilaian_klinik_umum/edit/' . $row->id_rincian_penilaian) ?>')"
                                                href="#" class="btn btn-warning btn-sm"><i
                                                    class="fas fa-pencil-alt"></i></a></td>
                                        <td class="text-center"><a
                                                onclick="deleteConfirm('<?php echo site_url('rincian_penilaian_klinik_umum/hapus/' . $row->id_rincian_penilaian) ?>')"
