            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-info">
                        ...
                        <?php
                        echo form_open(
                            'rincian_penilaian_klinik_umum/update',
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text"
                                        ...
                                        placeholder="Rincian Penilaian"><?= set_value('rincian_penilaian', htmlspecialchars(
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text"
                                        ...
                                        placeholder="Keterangan"><?= set_value('keterangan_penilaian', htmlspecialchars($rincian->keterangan_penilaian)) ?></textarea>
                                    <?= form_error(
                        ...
                        <div class="card-footer">
                            ...
                            <?php echo anchor('rincian_penilaian_klinik_umum', 'Kembali', [
