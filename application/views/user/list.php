                            ...
                            <table id="example2" class="table table-bordered table-striped width=" 100%"">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" rowspan="2">Nama User</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo $row->level_user; ?></td>
                                        ...
                                        <td class="text-center">
                                            <a onclick="deleteConfirm('<?php echo site_url('user/hapus/' . $row->kode_user); ?>')"
