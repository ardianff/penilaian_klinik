                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="bulan" class="col-sm-2 col-form-label">Bulan <span style="color:red">*</span></label>
                                <div class="col-sm-2">
                                    <?php
                                    $options = array(
                                        '' => '- Pilih -',
                            ...
                            <div class="form-group row">
                                <label for="tahun" class="col-sm-2 col-form-label">Tahun <span style="color:red">*</span></label>
                                <div class="col-sm-2">
                                    <?php
                                    $year_start  = 2018;
                                    $year_end = date('Y');
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($data as $row) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><a onclick="cekConfirm('<?php echo site_url('laporan_penilaian/cek/' . $row->id_klinik) ?>')" href="#" class="btn btn-info btn-sm" title="Cek Data <?php echo $row->nama_klinik ?>"><i class=" fa-solid fa-newspaper"></i></a></td>
