        ...
        <div class="col-md-8">
          ...
          <div class="card card-info">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                <label for="NIP_Anggota" class="col-sm-2 col-form-label">Tanda Tangan</label>
                <div class="col-sm-10">
                  <div class="col">
                    <div id="ttd3"></div>
                    <br />
                    <button class="btn-sm btn-danger" id="cls-ttd3">Clear</button>
                    <textarea id="signature64-ttd3" name="ttd-anggota" style="display: none" required
                      autofocus></textarea>
                  </div>
                  <?= form_error('ttd-anggota', '<small class="text-danger pl-3">', '</small>') ?>
                </div>
              </div>
            </div>
            <!-- /.card-body -->
