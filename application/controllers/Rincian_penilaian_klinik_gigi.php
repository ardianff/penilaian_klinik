...
class Rincian_penilaian_klinik_gigi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load(
            'template',
            'rincian-penilaian/klinik_gigi/list',
            $data
        );
    }
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->template->load('template', 'rincian-penilaian/klinik_gigi/add');
        } else {
            if (isset($_POST['submit'])) {
                ...
                redirect('rincian_penilaian_klinik_gigi');
            } else {
                $this->template->load(
                    'template',
                    'rincian-penilaian/klinik_gigi/add'
                );
            }
        }
    }
    public function edit($id)
    {
        ...
        $this->template->load(
            'template',
            'rincian-penilaian/klinik_gigi/edit',
            $data
        );
    }
    ...
    public function hapus()
    {
        ...
        $this->Model_rincian_penilaian_utama->delete_rincian_pertama($id);
        $this->session->set_flashdata(
            'delete',
