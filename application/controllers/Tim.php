...
Class Tim extends CI_Controller{
	...
	function index() {
        $data['daftar'] = $this->db->query("SELECT ts.id_anggota,ts.nama_anggota, ts.nip_anggota FROM tbl_anggota as ts")->result();
	...
	function edit(){
        if (isset($_POST['submit'])) {
            ...
            $data['anggota'] = $this->db->get_where('tbl_anggota',array('nip_anggota'=>$nip_anggota))->row_array();
