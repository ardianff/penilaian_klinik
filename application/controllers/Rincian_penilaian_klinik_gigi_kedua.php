...
class Rincian_penilaian_klinik_gigi_kedua extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template', 'rincian-penilaian-kedua/klinik_gigi/list', $data);
    }
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->template->load('template', 'rincian-penilaian-kedua/klinik_gigi/add', $data);
        } else {
            if (isset($_POST['submit'])) {
                ...
                redirect('rincian_penilaian_klinik_gigi_kedua');
            } else {
    ...
    public function edit($id)
    {
        ...
        $this->template->load(
            'template',
            'rincian-penilaian-kedua/klinik_gigi/edit',
            $data
        );
    }
    ...
    public function group_name()
    {
        ...
        $data['data'] = $this->Model_rincian_penilaian_utama->get_group_penilaian_utama();
        $this->template->load('template', 'rincian-penilaian-kedua/klinik_gigi/group-name/data', $data);
    }
    public function tambah_group()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->template->load('template', 'rincian-penilaian-kedua/klinik_gigi/group-name/tambah');
        } else {
            if (isset($_POST['submit'])) {
                ...
                redirect('rincian_penilaian_klinik_gigi_kedua/group_name');
            } else {
                $this->template->load(
                    'template',
                    'rincian-penilaian-kedua/klinik_gigi/group-name/tambah'
                );
            }
        }
    }
    public function edit_group($id)
    {
        ...
        $this->template->load(
            'template',
            'rincian-penilaian-kedua/klinik_gigi/group-name/edit',
            $data
        );
    }
